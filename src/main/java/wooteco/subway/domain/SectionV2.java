...
public class SectionV2 {
    ...
    public SectionV2(Long lineId, Station upStation, Station downStation, int distance) {
        this(null, lineId, upStation, downStation, distance);
    }

    public SectionV2(Long id, Long lineId, Station upStation, Station downStation, int distance) {
    ...
    public boolean hasStation(SectionV2 section) {
    ...
    public boolean isSameStation(SectionV2 section) {
    ...
    public boolean isOverDistance(SectionV2 section) {
