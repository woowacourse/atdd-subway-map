...
public class MemoryLineDao implements LineDao {
    ...
    public void update(final Line line) {
        Line findLine = findById(line.id()).orElseThrow(() -> new IllegalArgumentException("[ERROR] 존재하지 않는 노선입니다."));
        line.changeName(findLine.name());
        line.changeColor(findLine.color());
    }
