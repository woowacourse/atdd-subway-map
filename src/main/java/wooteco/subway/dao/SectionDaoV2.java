...
public class SectionDaoV2 {
    ...
    public SectionDaoV2(DataSource dataSource) {
    ...
    public Long save(SectionV2 section) {
    ...
    public SectionV2 findById(Long id) {
    ...
    public List<SectionV2> findByLineId(Long lineId) {
        String sql = "SELECT s.id AS section_id, s.line_id, s.up_station_id, s.down_station_id, s.distance,"
                + " us.name AS up_station_name, ds.name AS down_station_name"
                + " FROM section AS s"
                + " LEFT JOIN station AS us ON us.id = s.up_station_id"
    ...
    public void deleteSections(List<SectionV2> sections) {
    ...
    private RowMapper<SectionV2> rowMapper() {
        return ((rs, rowNum) -> {
