...
public class StationDao2 {
    ...
    public StationDao2(NamedParameterJdbcTemplate jdbcTemplate) {
    ...
    public boolean checkById(Long id) {
        ...
        return isPresent(jdbcTemplate.query(sql, paramSource, stationRowMapper));
    }
    ...
    private boolean isPresent(List<Station> stations) {
