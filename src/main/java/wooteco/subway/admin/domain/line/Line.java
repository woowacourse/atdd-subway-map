...
public class Line {
	...
	public Line(Long id, String name, LocalTime start, LocalTime end, int intervalTime,
		...
		this(id, name, new LineTimeTable(start, end, intervalTime), bgColor, new LineStations(stations));
	}
	...
	public void update(Line line) {
		...
		if (line.lineTimeTable != null) {
			this.lineTimeTable = line.lineTimeTable;
		}
