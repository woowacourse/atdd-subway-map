...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFoundLineStationException(NotFoundLineStationException e) {
        return ResponseEntity.badRequest()
                .body(ErrorResponse.of("구간이 존재하지 않습니다."));
    }

    @ExceptionHandler(DuplicatedStationException.class)
    public ResponseEntity<ErrorResponse> handleDuplicatedStationException(DuplicatedStationException e) {
        return ResponseEntity.badRequest()
    ...
    public ResponseEntity<ErrorResponse> handleDuplicatedLineStationException(DuplicatedLineStationException e) {
        return ResponseEntity.badRequest()
