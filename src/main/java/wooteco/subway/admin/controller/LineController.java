...
public class LineController {
    ...
    public ResponseEntity<LineResponse> appendStationToLine(@PathVariable Long id, @RequestBody StationCreateRequest request) {
        Line line = new Line(id, "8호선", LocalTime.of(5, 40), LocalTime.of(23, 57), 8, "bg-pink-500", new HashSet<>());
