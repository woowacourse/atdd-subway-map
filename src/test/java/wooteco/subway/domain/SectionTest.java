...
class SectionTest {
    ...
    void createSectionInBetweenWhenFirstDownAndSecondUpIsSame() {
        ...
        assertThat(newSection).usingRecursiveComparison()
                .isEqualTo(new Section(section1.getId(), section2.getDownStation(), section1.getDownStation(), 5, section1.getLineId()));
    }
    ...
    void createSectionInBetweenWhenSecondUpAndFirstDownIsSame() {
        ...
        assertThat(newSection).usingRecursiveComparison()
                .isEqualTo(new Section(section1.getId(), section1.getUpStation(), section2.getUpStation(), 5, section1.getLineId()));
    }
