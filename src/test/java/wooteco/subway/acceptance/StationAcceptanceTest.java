...
public class StationAcceptanceTest extends AcceptanceTest {
    ...
    private static final String STATION_PARAM_KEY = "name";
    ...
    void createStation_duplicateName_exception() {
        ...
        ExtractableResponse<Response> createResponse2 = createStationByMap("선릉역");
        // then
    ...
    private ExtractableResponse<Response> createStationByMap(String value) {
        Map<String, String> stationParameter = new HashMap<>();
        stationParameter.put(STATION_PARAM_KEY, value);

        return RestAssured.given().log().all()
            .body(stationParameter)
            .contentType(MediaType.APPLICATION_JSON_VALUE)
            .when()
            .post("/stations")
            .then().log().all()
