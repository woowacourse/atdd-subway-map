...
public class StationAcceptanceTest extends AcceptanceTest {
    ...
    public static ExtractableResponse<Response> postStations(final StationRequest stationRequest) {
    ...
    void createStationWithDuplicateName() {
        // given
        postStations(new StationRequest("강남역"));

        // when
        ExtractableResponse<Response> response = postStations(new StationRequest("강남역"));
    ...
    void deleteStation() {
        // given
        String location = postStations(new StationRequest("강남역"))
                .header("Location");
