...
public class LineServiceTest {
    ...
    void addLineStationAtTheFirstOfLine() {
        ...
        assertThat(line.getLineStations().get(0).getStationId()).isEqualTo(1L);
        assertThat(line.getLineStations().get(1).getStationId()).isEqualTo(2L);
        assertThat(line.getLineStations().get(2).getStationId()).isEqualTo(3L);
        assertThat(line.getLineStations().get(3).getStationId()).isEqualTo(4L);
    }
    ...
    void removeLineStationAtTheFirstOfLine() {
        ...
        assertThat(line.getLineStations().get(0).getStationId()).isEqualTo(2L);
