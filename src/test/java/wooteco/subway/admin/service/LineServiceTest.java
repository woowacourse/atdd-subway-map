...
public class LineServiceTest {
    ...
    void addLineStationAtTheFirstOfLine() {
        ...
        assertThat(line.getAllStationIds().get(0)).isEqualTo(4L);
        assertThat(line.getAllStationIds().get(1)).isEqualTo(1L);
        assertThat(line.getAllStationIds().get(2)).isEqualTo(2L);
        assertThat(line.getAllStationIds().get(3)).isEqualTo(3L);
    }
    ...
    void addLineStationBetweenTwo() {
        ...
        assertThat(line.getLineStations()).hasSize(4);
        assertThat(line.getAllStationIds().get(0)).isEqualTo(1L);
        assertThat(line.getAllStationIds().get(1)).isEqualTo(4L);
        assertThat(line.getAllStationIds().get(2)).isEqualTo(2L);
        assertThat(line.getAllStationIds().get(3)).isEqualTo(3L);
    }
    ...
    void addLineStationAtTheEndOfLine() {
        ...
        assertThat(line.getLineStations()).hasSize(4);
        assertThat(line.getAllStationIds().get(0)).isEqualTo(1L);
        assertThat(line.getAllStationIds().get(1)).isEqualTo(2L);
        assertThat(line.getAllStationIds().get(2)).isEqualTo(3L);
        assertThat(line.getAllStationIds().get(3)).isEqualTo(4L);
    }
    ...
    void removeLineStationAtTheFirstOfLine() {
        ...
        assertThat(line.getAllStationIds().get(0)).isEqualTo(2L);
        assertThat(line.getAllStationIds().get(1)).isEqualTo(3L);
    }
