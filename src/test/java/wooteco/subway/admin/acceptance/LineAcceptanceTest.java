...
public class LineAcceptanceTest {
	...
	void manageLine() {
		...
		updateLine(line.getId(), line.getName(), line.getColor(), startTime, endTime);
		//then
	...
	private void updateLine(Long id, String name, String color, LocalTime startTime, LocalTime endTime) {
		Map<String, String> params = new HashMap<>();
		params.put("name", name);
