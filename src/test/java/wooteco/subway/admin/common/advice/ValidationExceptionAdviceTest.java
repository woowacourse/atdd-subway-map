...
class ValidationExceptionAdviceTest {
    ...
    void name() throws Exception {
        //given
        Constructor<LineCreateRequest> lineCreateRequestConstructor = LineCreateRequest.class.getDeclaredConstructor(null);
        lineCreateRequestConstructor.setAccessible(true);
        LineCreateRequest lineCreateRequest = lineCreateRequestConstructor.newInstance(null);
