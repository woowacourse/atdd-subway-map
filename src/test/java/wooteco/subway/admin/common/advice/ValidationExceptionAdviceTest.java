...
class ValidationExceptionAdviceTest {
    ...
    void name() throws Exception {
        ...
        DefaultResponse<String> defaultExceptionResponses = objectMapper.readValue(contentAsString, new TypeReference<DefaultResponse<String>>() {
        });

        //then
        assertThat(defaultExceptionResponses.getMessage()).isNotBlank();
    }
