...
public class Fixture {
    ...
    public static final LineRequest LINE_REQUEST_분당선 = new LineRequest("분당선", "bg-red-601", 3L, 4L, 12);
    ...
    public static final Line LINE_1_BLUE = new Line("1호선", "blue", 1L, 2L, 10);
    public static final Line LINE_2_GREEN = new Line("2호선", "green", 3L, 4L, 12);
