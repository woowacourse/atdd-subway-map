...
public class LineTestFixture {
    ...
    public static ExtractableResponse<Response> _7호선_및_역_생성요청() {
        ...
        Map<String, String> line = new HashMap<>(_7호선);
        line.put("upStationId", String.valueOf(stationId1));
        line.put("downStationId", String.valueOf(stationId2));
        line.replace("distance", "10");

        return post(LINE, line);
    }
    ...
    public static ExtractableResponse<Response> 분당선_및_역_생성요청() {
        ...
        Map<String, String> line = new HashMap<>(신분당선);
        line.put("upStationId", String.valueOf(stationId1));
        line.put("downStationId", String.valueOf(stationId2));
