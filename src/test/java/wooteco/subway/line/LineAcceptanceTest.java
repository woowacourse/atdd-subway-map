...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    @CsvSource(value = {"null,null,null,null", "4,null,2,3", "4,1,null,3", "4,1,2,null",
        "null,1,2,3"},
        nullValues = {"null"})
    void createLineFailureWhenNullProperties(String name, String upStationId, String downStationId,
        String color) {
        // given
        Map<String, String> params = new HashMap<>();
        params.put("name", "2호선");
    ...
    void createLineFailureWhenEmptyProperties(String name, String upStationId, String downStationId,
        String color) {
        // given
        Map<String, String> params = new HashMap<>();
        params.put("name", "2호선");
    ...
    void updateStation() {
        ...
        // then
        assertThat(response.statusCode()).isEqualTo(HttpStatus.OK.value());
        assertThat(findResponse.jsonPath().getObject(".", LineResponse.class).getColor())
            .isEqualTo("blue");
        assertThat(findResponse.jsonPath().getObject(".", LineResponse.class).getName())
            .isEqualTo("2호선");
    }
