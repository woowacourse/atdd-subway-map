...
public class SectionAcceptanceTest extends AcceptanceTest {
    ...
    void createSectionWithTopStation() {
        ...
        final StationResponse gangnam = new StationResponse(1L, "강남역");
        final StationResponse yeoksam = new StationResponse(2L, "역삼역");
        final StationResponse seolleung = new StationResponse(3L, "선릉역");
