...
//        assertThat(response.as(SectionCreateRequest.class))
//                .usingRecursiveComparison()
//                .isEqualTo(new SectionCreateRequest(
//                        2L, 1L, 1L, 3L, 5));
//    }
//
...
//        assertThat(response.as(SectionCreateRequest.class))
//                .usingRecursiveComparison()
//                .isEqualTo(new SectionCreateRequest(2L, 1L, 3L, 2L, 5));
//    }
//
...
//        assertThat(response.as(SectionCreateRequest.class))
//                .usingRecursiveComparison()
//                .isEqualTo(new SectionCreateRequest(2L, 1L, 3L, 1L, 5));
//    }
//
...
//        assertThat(response.as(SectionCreateRequest.class))
//                .usingRecursiveComparison()
//                .isEqualTo(new SectionCreateRequest(2L, 1L, 2L, 3L, 5));
//    }
//
